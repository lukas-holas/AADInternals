// TODO: same as import-personal_sharedinsights.cypher
LOAD CSV WITH HEADERS FROM 'file:///users_sharedinsights.csv' AS row
MERGE (file:File {
    id: row.id
})
...
MERGE (s:Shared {id: row.sharedInsightId})
MERGE (file)-[r4:IS_SHARED]-(s)
