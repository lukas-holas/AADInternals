// TODO: almost the same as import-personal_people_groups.cypher (param userId instead of personalId)
LOAD CSV WITH HEADERS FROM 'file:///users_people_groups.csv' AS row
MERGE (g:Group {
    id: row.id
})
